...
from services.platform_matching.logic import before_launching_platform_matching_server
...
def platform_matching_service_definition():
    return ServiceDefinition(
        ...
        before_launching_service=before_launching_platform_matching_server
    )