...
from services.merchant_pos_callback.rqrsp import MerchantPosCallbackResponse, PlatformReceiptMatchExternalNotification
...
class MerchantPosCallbackClient(ServiceClientBase):
    ...
    def __init__(self, endpoint: Endpoint = service_endpoint_from_env(Service.MERCHANT_POS_CALLBACK)):
        super().__init__(endpoint, PlatformReceiptMatchExternalNotification, MerchantPosCallbackResponse)
