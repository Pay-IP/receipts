...
from services.iss_bank_new_pmt.logic import handle_get_issuing_bank_client_account_by_id, handle_get_issuing_bank_client_account_debit_by_id, handle_get_issuing_bank_client_account_debits, handle_get_issuing_bank_client_account_debits_by_id, handle_get_issuing_bank_client_accounts, handle_issuing_bank_new_payment_request_from_payment_processor
...
def api():
    ...
    @api.get("/client_account_debits/{id}")
    def get_issuing_bank_client_account_debits_by_id(id):
        return request_handler(
            definition,
            None,
            handle_get_issuing_bank_client_account_debits_by_id
        )(id)
